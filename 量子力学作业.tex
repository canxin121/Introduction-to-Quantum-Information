...
&= \frac{i\hslash}{\left( {2\pi\hslash} \right)^{3}}{\int{exp\left( {- \frac{i}{\hslash}\overset{\rightarrow}{p_{1}} \cdot \overset{\rightarrow}{r}} \right)}} \\
...
&= i\hslash\left( {p_{z}\frac{\partial}{\partial p_{y}} - p_{y}\frac{\partial}{\partial p_{z}}} \right) \\
...
因此：
\[\left( \hat{L_{x}} \right)_{p_{1}p} = i\hslash\left( p_{z}\frac{\partial}{\partial p_{y}} - p_{y}\frac{\partial}{\partial p_{z}} \right)\delta\left( {\overset{\rightarrow}{p} - \overset{\rightarrow}{p_{1}}} \right)\]
\textbf{等价写法：}这就是动量空间中的角动量算符
\[
\hat L_x=i\hslash(\nabla_p\times\vec p)_x
= i\hslash\left(p_z\frac{\partial}{\partial p_y}-p_y\frac{\partial}{\partial p_z}\right),
\]
\textbf{行列式推导：}
\[
\nabla_p\times\vec p=
...
\[
(\nabla_p\times\vec p)_x
=p_z\frac{\partial}{\partial p_y}-p_y\frac{\partial}{\partial p_z},
\]
从而
\[
\hat L_x=i\hslash(\nabla_p\times\vec p)_x
...
= i\hslash\left(p_{1z}\frac{\partial}{\partial p_{1y}}-p_{1y}\frac{\partial}{\partial p_{1z}}\right)
